...
class SecureCheckOutPage extends StatelessWidget {
  ...
  SecureCheckOutPage({required this.productBrand, required this.productName, required this.price, required this.imagePath});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ProductBox(productBrand: this.productBrand, productName: this.productName, price: this.price, imagePath: this.imagePath),
              SizedBox(height: 20, width: double.infinity),
              const Padding(
                padding: const EdgeInsets.only(left: 10),
                child: Text(
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildPaymentMethodItem('Credit Card / Debit Card', 'Promotion avaliable'),
                        Divider(),
                        _buildPaymentMethodItem('Bank Transfer / Counter Services', 'Using a reference code'),
                        Divider(),
                        _buildPaymentMethodItem('Pay On Delivery', 'Messenger will contact you for a confirmation'),
                      ],
                    ),
                  ),
                ],
              ...
              Center(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(vertical: 18.0, horizontal: 100.0),
